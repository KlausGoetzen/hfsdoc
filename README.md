...
An online version of this documentation is located at [https://klausgoetzen.github.io/hfsdoc/](https://klausgoetzen.github.io/hfsdoc/). The **HepFastSim** package itself is available under the GPLv3 license at [https://git.gsi.de/k.goetzen/hepfastsim](https://git.gsi.de/k.goetzen/hepfastsim).
