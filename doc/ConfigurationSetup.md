...
| `storeopt`  | store options for composites and event shape; veto with !\<option>. Available options: `all, cms, 2body, dalitz, pid, micro, truth, pos, fit, mult, max, sum, shape`) | `all` (store everything)           |
...
| `file`      | name of output file                                                                                                                                                   | ana\__config-filename_\__tag_.root |
